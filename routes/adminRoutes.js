...
routes.post('/products/addProduct', adminAuth, upload.array('productImages'), uploadToCloudinary, productRoutes.addProduct)
routes.get('/products/editProductForm/:id', adminAuth, productRoutes.editProductForm)
routes.post('/products/editProduct/:id', adminAuth, upload.array('productImages'), uploadToCloudinary, productRoutes.editProduct)
